...
public class Library extends javax.swing.JFrame {
    ...
    SynthesiserV2 speak = new SynthesiserV2("AIzaSyBOti4mM-6x9WDnZIjIeyEU21OpBXqWBgw");
    ...
    private void Mp3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Mp3ActionPerformed
        ...
        if (color == 1) {
            String eng = engText.getText();
            new MP3Player(new File("C:\\Users\\Admin\\Documents\\NetBeansProjects\\DictionaryLibrary\\src\\Mp3\\" + eng + ".mp3")).play();
        } else {
            String eng = engText.getText();
